...
const input =
  'w-full px-4 py-3 rounded-xl border border-neutral-200 dark:border-neutral-700 bg-white dark:bg-neutral-900 text-neutral-900 dark:text-neutral-100 placeholder:text-neutral-400 dark:placeholder:text-neutral-600 focus:outline-none focus:ring-2 focus:ring-indigo-500/50 focus:border-indigo-500 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200'

interface Props {
  onSearch: (categoria: string, ubicacion: string, cantidad: number) => void
  loading: boolean
}
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-4">
        ...
        <div className="flex gap-3">
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <button
              type="submit"
              disabled={loading || !categoria.trim() || !ubicacion.trim()}
